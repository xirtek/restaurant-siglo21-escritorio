...
{
    public partial class AdminMantenedorCliente : Form
    {
        ...
        private void AdminMantenedorCliente_FormClosing(object sender, FormClosingEventArgs e)
        {
