...
{
    public partial class AdminMantenedorReserva : Form
    {
        ...
        private void AdminMantenedorReserva_FormClosing(object sender, FormClosingEventArgs e)
        {
            AdminMantenedorReserva frm = new AdminMantenedorReserva();
