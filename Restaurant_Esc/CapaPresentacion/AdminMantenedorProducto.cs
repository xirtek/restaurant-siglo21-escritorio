...
{
    public partial class AdminMantenedorProducto : Form
    {
        ...
        public AdminMantenedorProducto()
        {
            InitializeComponent();
        ...
        private void MantenedorProducto_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void dgvProductos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtStock.Text = dgvProductos.CurrentRow.Cells[2].Value.ToString();
            cboDetalleStock.Text = dgvProductos.CurrentRow.Cells[3].Value.ToString();
            //cbo
            string valor = dgvProductos.CurrentRow.Cells[4].Value.ToString();
        ...
        private void txtDetalleStock_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        {
            if (btnVolver.ContainsFocus || btnCerrarSesion.ContainsFocus || btnLimpiar.ContainsFocus || btnEliminar.ContainsFocus || dgvProductos.ContainsFocus)
            {
                return;
            }
            else
